...
%
There need to be a second network address translation (NAT) on the tunnel interface of the client nodes because the GW node, at the other end of the tunnel, does not know anything about the IP addresses leased to the dhcp-clients (the ordinary computers) of node C. 
