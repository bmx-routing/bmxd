...
static int8_t uci_reload_package( struct uci_context *ctx, struct uci_ptr *ptr, char* package ) {
...
static struct uci_element *uci_lookup( struct uci_context *ctx, struct uci_ptr *ptr, char *name ) {
...
static int uci_save_option( struct uci_context *ctx, char *conf_name, char *sect_name, char *opt_name, char *opt_val, struct ctrl_node *cn ) {
...
static int uci_create_section(  struct uci_context *ctx, char *conf_name, char *sect_name, char *opt_name, struct ctrl_node *cn ) {
...
static int uci_remove(  struct uci_context *ctx, char *conf_name, char *sect_name, char *opt_name, struct ctrl_node *cn ) {
...
static int uci_get_sect_name( uint8_t create, struct ctrl_node *cn, struct uci_context *ctx, 
...
static int bmx_derive_config ( char *reference, char *derivation, struct ctrl_node *cn ) {
...
static int bmx_save_config ( uint8_t del, struct opt_type *opt, char *p_val, char *c_val, struct ctrl_node *cn ) {
...
static int bmx_load_config ( uint8_t cmd, struct opt_type *opt, struct ctrl_node *cn ) {
...
static int32_t opt_conf_reload ( uint8_t cmd, uint8_t _save, struct opt_type *opt, struct opt_parent *patch, struct ctrl_node *cn ) {
...
static int32_t opt_conf_file ( uint8_t cmd, uint8_t _save, struct opt_type *opt, struct opt_parent *patch, struct ctrl_node *cn ) {
...
static int8_t show_conf ( struct ctrl_node *cn, void *data, struct opt_type *opt, struct opt_parent *p, struct opt_child *c ) {
...
static int32_t opt_show_conf ( uint8_t cmd, uint8_t _save, struct opt_type *opt, struct opt_parent *patch, struct ctrl_node *cn ) {
...
//        ord parent long_name          shrt Attributes				*ival		min		max		default		*func,*syntax,*help
	...
	{ODI,5,0,ARG_SHOW_CONFIG,	0,  A_PS0,A_ADM,A_DYN,A_ARG,A_ANY,	0,		0, 		0,		0, 		opt_show_conf,
...
static int32_t conf_init( void ) {

	memset( &tmp_conf_opt, 0, sizeof( struct opt_type ) );
	INIT_LIST_HEAD( &tmp_conf_opt.d.list );
	INIT_LIST_HEAD_FIRST( tmp_conf_opt.d.childs_type_list );
	INIT_LIST_HEAD_FIRST( tmp_conf_opt.d.parents_instance_list );
...
struct plugin_v1* get_plugin_v1( void ) {
	...
	static struct plugin_v1 conf_plugin_v1;
	
	memset( &conf_plugin_v1, 0, sizeof ( struct plugin_v1 ) );
	
	conf_plugin_v1.plugin_version = PLUGIN_VERSION_01;
	conf_plugin_v1.plugin_name = "bmx_uci_config_plugin";
	conf_plugin_v1.plugin_size = sizeof ( struct plugin_v1 );
	conf_plugin_v1.cb_init = conf_init;
	conf_plugin_v1.cb_cleanup = conf_cleanup;

	return &conf_plugin_v1;
}
